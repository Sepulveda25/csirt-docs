...
Habilite los Analyzers que necesita, configúrelos utilizando las pestañas **Organization**> **Configuration** y **Organization**> **Analyzers**. Toda la configuración del analizador se realiza mediante la interfaz de usuario web, incluida la adición de claves API y la configuración de límites de velocidad.
